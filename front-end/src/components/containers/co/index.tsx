...
const JsonData = [
	{
		...
		linkedIn: "https://www.linkedin.com/in/nika-botchorishvili-a27b09234/",
	},
	{
		id: 2,
		image: gio,
		...
		linkedIn: "https://www.linkedin.com/in/giorgi-lomsianidze-bb2aba229/",
	},
];
		...
		<div className="about_zappy_slide mx-auto w-[80%] h-fit flex flex-col max-w-sm md:flex-row md:max-w-none md:gap-20 md:relative">
			...
			<div className=" md:absolute md:w-full md:-bottom-10 md:h-fit md:flex md:justify-center md:items-center">
				...
				<LinkBig
					...
					link={
						currentSlide == 0
							? "https://www.linkedin.com/in/nika-botchorishvili-a27b09234/"
							: "https://www.linkedin.com/in/giorgi-lomsianidze-bb2aba229/"
					}
				/>
